...
) -> crate::utils::error::Result<EmbeddingResponse> {
...
/// # }
/// ```
pub async fn embed_text(model: &str, text: &str) -> crate::utils::error::Result<Vec<f32>> {
...
pub async fn embed_texts(
    model: &str,
    texts: &[&str],
) -> crate::utils::error::Result<Vec<Vec<f32>>> {
